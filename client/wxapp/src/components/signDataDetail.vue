<template>
	<view class="card-container">
		<view class="status">
			...
			<view class="price">
				<view>预计消费:</view>
				<view class="num" v-if="totalValue != undefined">{{ `${Math.ceil(totalValue / 100)} ¥` }}</view>
		...
		<button class="btn btn-primary" hover-class="btn-primary-hover" @click="submit">即刻结算</button>
	</view>
</template>
